...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    if ( remoteNotif )
    {
        /*[[[UIAlertView alloc] initWithTitle:@"Push Notification Received : A"
...
{
    /*[[[UIAlertView alloc] initWithTitle:@"Push Notification Received : B"
...
{
    [AccountManager synchronizePushToken:deviceToken];
}
...
- (NSManagedObjectModel *)managedObjectModel
{
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"RelayAnchor" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"RelayAnchor.sqlite"];
